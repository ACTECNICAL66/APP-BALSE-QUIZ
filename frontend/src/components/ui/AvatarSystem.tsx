...
export const AVATAR_OPTIONS: AvatarOption[] = [
  {
    ...
    description: 'Estudiante recién iniciado en el mundo de la técnica'
  },
  {
    id: 'mechanic',
    emoji: '👨‍🔧',
    name: 'Mecánico de Taller',
    gradient: 'from-orange-500 to-amber-500',
    borderColor: 'border-orange-400/50',
    description: 'Maestro del torno, la morsa y la soldadura'
  },
  {
    id: 'coder',
    emoji: '👩‍💻',
    ...
    description: 'Experto en bucles, punteros y Arduino'
  },
  {
    id: 'robot',
    emoji: '🤖',
    ...
    description: 'El compañero oficial del IPET 66'
  },
  {
    id: 'scientist',
    emoji: '👩‍🔬',
    ...
    description: 'Especialista en mediciones y precisión'
  },
  {
    id: 'lightning',
    emoji: '⚡',
    ...
    description: 'Domina las leyes de Ohm y Kirchhoff'
  },
  {
    id: 'engineer',
    emoji: '🛠️',
    name: 'Ingeniero en Formación',
    gradient: 'from-slate-500 to-zinc-600',
    borderColor: 'border-slate-400/50',
    description: 'Futuro graduado del IPET 66'
  },
  {
    id: 'plug',
    emoji: '🔌',
    ...
    description: 'Especialista en circuitos industriales'
  },
  {
    id: 'welder',
    emoji: '🔥',
    ...
    description: 'Artista del arco eléctrico y la escoria'
  },
  {
    id: 'chip',
    emoji: '💡',
    ...
    description: 'Mente brillante con ideas de proyecto final'
  },
];
