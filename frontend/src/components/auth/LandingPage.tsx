...
import { ArrowRight, Cpu, ShieldCheck, Trophy, Sparkles, Zap, Flame, CheckCircle, ChevronRight } from 'lucide-react';
import { MASCOT_INFO, SCHOOL_INFO, CURRICULUM_DATA } from '../../data/curriculumData';
        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between relative z-10">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="btn-3d-green text-white font-black px-6 py-3 rounded-2xl text-xs uppercase tracking-wider shadow-xl shadow-emerald-500/40"
            >
              Empezar
            </button>
          </div>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-center relative z-10">
          ...
          <div className="lg:col-span-7 text-center lg:text-left">
            ...
            <p className="text-xl text-slate-300 font-bold mb-10 max-w-2xl mx-auto lg:mx-0 leading-relaxed drop-shadow-lg">
              Aprende todas las materias del IPET 66 desde 1ro hasta 7mo año con un sistema gamificado estilo Duolingo. Desbloquea niveles, compite con tus compañeros y domina el taller.
            </p>

            {/* Year Selector Card */}
            <div className="liquid-glass-strong rounded-3xl p-6 mb-8 max-w-lg mx-auto lg:mx-0 shadow-2xl border border-white/15">
              <div className="flex items-center justify-between mb-4">
                <div>
                  <div className="text-xs font-black text-slate-400 uppercase tracking-widest mb-1">Tu Año Actual</div>
                  <div className="text-2xl font-black text-white">{selectedYear}º Año</div>
                </div>
                <button
                  onClick={() => {
                    soundEffects.playClick();
                  ...
                  className="p-3 rounded-2xl liquid-glass-blue text-blue-300 hover:text-white transition-all shadow-lg"
                >
                  <ChevronRight className={`w-6 h-6 transition-transform ${showYearPicker ? 'rotate-90' : ''}`} />
                </button>
              </div>

              {showYearPicker && (
                <div className="grid grid-cols-7 gap-2 animate-in slide-in-from-top-2 duration-200">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 mb-12">
              <button
                ...
                className="w-full sm:w-auto btn-3d-green text-white font-black px-12 py-6 rounded-3xl text-base uppercase tracking-wider flex items-center justify-center gap-3 shadow-2xl shadow-emerald-500/50 animate-pulse-glow"
              >
      ...
      <section className="py-24 px-6 relative z-10">
        <div className="max-w-7xl mx-auto">
          <div className="text-center max-w-3xl mx-auto mb-20">
            ...
            <h2 className="text-4xl sm:text-5xl font-black text-white mb-6 tracking-tight drop-shadow-2xl">
              El método Duolingo en la Escuela Técnica
            </h2>
            <p className="text-xl text-slate-300 font-bold">
              Cada acierto consecutivo multiplica tu combo y tu XP. ¡Enciende tu racha!
            </p>
          </div>
      ...
      <footer className="mt-auto liquid-glass-strong border-t border-white/10 py-12 px-6 relative z-10">
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-6 text-center sm:text-left">
          ...
          <button
            ...
            className="btn-3d-green text-white font-black px-10 py-4 rounded-2xl text-sm uppercase tracking-wider shadow-xl shadow-emerald-500/40"
          >
            Crear mi cuenta
          </button>
        </div>
