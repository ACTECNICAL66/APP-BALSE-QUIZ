...
export const LessonModal: React.FC<LessonModalProps> = ({
  ...
  const handleCheck = () => {
    ...
    if (correct) {
      ...
      // A wrong answer fails the activity. No XP is awarded and the level must be retried.
  ...
  const verifyPair = (left: string, right: string) => {
    ...
    if (validPair) {
      ...
      setSelectedRight(null);
      if (hasStreakFreeze) {
        alert("¡Escudo Anti-Fallo activado! Tu combo se mantiene, pero debes repetir la actividad.");
        onConsumeFreeze();
      } else {
        setLiveCombo(0);
      }
        ...
        {isLessonFinished ? (
          <div className="my-auto text-center space-y-8 animate-in zoom-in-95 duration-300">
            <div className="w-32 h-32 mx-auto rounded-3xl bg-gradient-to-tr from-emerald-500 to-teal-400 flex items-center justify-center text-7xl shadow-2xl shadow-emerald-500/40 border border-emerald-300/40">
              <Crown className="w-20 h-20 text-white fill-white" />
            </div>
          ...
          <div className="my-auto text-center space-y-8 animate-in zoom-in-95 duration-300">
            <div className="w-32 h-32 mx-auto rounded-3xl bg-gradient-to-tr from-rose-500 to-red-500 flex items-center justify-center shadow-2xl shadow-rose-500/40 border border-rose-300/40">
            ...
            <div className="space-y-3">
              ...
              <p className="text-sm text-slate-300 font-bold max-w-xl mx-auto leading-relaxed">
                En esta app una respuesta incorrecta no cuenta como nivel aprobado. No recibes XP ni tuercas por esta actividad y tendrás que repetirla desde el inicio.
              </p>
            </div>

            <div className="liquid-glass border border-rose-500/30 rounded-3xl p-5 text-left max-w-xl mx-auto shadow-xl">
              <div className="flex items-start gap-4">
                <div className="w-12 h-12 rounded-2xl bg-rose-500/20 text-rose-300 flex items-center justify-center shrink-0 border border-rose-500/30">
                  <AlertTriangle className="w-6 h-6" />
                </div>
                <div>
                  <div className="font-black text-rose-300 text-sm uppercase tracking-widest mb-1">
                    ¿Qué pasó?
                  </div>
            ...
            <div className="grid grid-cols-2 gap-4 max-w-md mx-auto">
              ...
              <div className="bg-slate-900 liquid-glass border border-slate-700/80 rounded-3xl p-4 text-center shadow-xl">
                <div className="text-xs font-bold text-slate-400 uppercase mb-1">Combo</div>
                <div className="text-2xl font-black text-orange-400">{liveCombo}</div>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto">
              <button
                ...
                className="w-full btn-3d-blue text-white font-black py-4 rounded-2xl text-sm uppercase tracking-wider shadow-xl shadow-blue-500/20 flex items-center justify-center gap-2"
              >
              ...
              <button
                ...
                className="w-full btn-3d-gray text-slate-200 font-black py-4 rounded-2xl text-sm uppercase tracking-wider"
              >
                Salir sin puntos
              </button>
            </div>
